            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        ...
                        <h1 class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex" style="color: darkblue;">LOGGED IN AS &nbsp;</h1>
                        <div style="color: darkblue;">{{ strtoupper(Auth::user()->usertype) }} &nbsp;</div>
                        <div style="color: darkblue;">{{ Auth::user()->univ_num }}</div>
